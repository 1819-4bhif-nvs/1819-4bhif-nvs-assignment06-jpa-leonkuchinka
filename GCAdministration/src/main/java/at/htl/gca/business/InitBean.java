...
public class InitBean {
    ...
    private void init(){
        ...
        TeamPlayer christophBleier = new TeamPlayer("Christoph Bleier", 2.7, 17, true, 2015);
        ...
        TeeTime firstFlight = new TeeTime(LocalDate.of(2018, 11, 26));
        firstFlight.addPlayer(leonKuchinka);
        firstFlight.addPlayer(christophBleier);
        em.persist(firstFlight);

        TeeTime secondFlight = new TeeTime(LocalDate.of(2018, 11, 27));
